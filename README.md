...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/plain-leaf-1c65)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/plain-leaf-1c65#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/plain-leaf-1c65
```

A live public deployment of this template is available at [https://plain-leaf-1c65.templates.workers.dev](https://plain-leaf-1c65.templates.workers.dev)
